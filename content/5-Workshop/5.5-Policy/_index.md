...
![endpoint diagram]({{< relURL "images/5-Workshop/5.5-Policy/s3-bucket-policy.png" >}})
...
```
![test]({{< relURL "images/5-Workshop/5.5-Policy/test1.png" >}})
...
![create bucket]({{< relURL "images/5-Workshop/5.5-Policy/create-bucket.png" >}})

Successfully create bucket

![Success]({{< relURL "images/5-Workshop/5.5-Policy/create-bucket-success.png" >}})
...
![policy]({{< relURL "images/5-Workshop/5.5-Policy/policy1.png" >}})
...
![custom policy]({{< relURL "images/5-Workshop/5.5-Policy/policy2.png" >}})

Successfully customize policy

![success]({{< relURL "images/5-Workshop/5.5-Policy/success.png" >}})
...
![error]({{< relURL "images/5-Workshop/5.5-Policy/error.png" >}})
...
![success]({{< relURL "images/5-Workshop/5.5-Policy/test2.png" >}})

This operation succeeds because it is permitted by the VPC endpoint policy.

![success]({{< relURL "images/5-Workshop/5.5-Policy/test2-success.png" >}})
...
![fail]({{< relURL "images/5-Workshop/5.5-Policy/test2-fail.png" >}})
