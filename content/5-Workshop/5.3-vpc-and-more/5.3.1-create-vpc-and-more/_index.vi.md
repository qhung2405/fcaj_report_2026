...
![vpc diagram]({{< relURL "images/5-Workshop/5.3-vpc/5.3.1-create-vpc-and-more/vpc4.png" >}})

![vpc diagram]({{< relURL "images/5-Workshop/5.3-vpc/5.3.1-create-vpc-and-more/vpc5.png" >}})

![vpc diagram]({{< relURL "images/5-Workshop/5.3-vpc/5.3.1-create-vpc-and-more/vpc6.png" >}})
